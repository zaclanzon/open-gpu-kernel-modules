...
// corresponding changes to the buildmeister script
    ...
    #define NV_BUILD_BRANCH             r597_06
#endif
#ifndef NV_PUBLIC_BRANCH
    #define NV_PUBLIC_BRANCH             r597_06
#endif

#if defined(NV_LINUX) || defined(NV_BSD) || defined(NV_SUNOS)
#define NV_BUILD_BRANCH_VERSION         "rel/gpu_drv/r595/r597_06-386"
#define NV_BUILD_CHANGELIST_NUM         (38816880)
#define NV_BUILD_TYPE                   "Official"
#define NV_BUILD_NAME                   "rel/gpu_drv/r595/r597_06-386"
#define NV_LAST_OFFICIAL_CHANGELIST_NUM (38816880)

#else     /* Windows builds */
#define NV_BUILD_BRANCH_VERSION         "r597_06-2"
#define NV_BUILD_CHANGELIST_NUM         (38802797)
#define NV_BUILD_TYPE                   "Official"
#define NV_BUILD_NAME                   "597.09"
#define NV_LAST_OFFICIAL_CHANGELIST_NUM (38802797)
